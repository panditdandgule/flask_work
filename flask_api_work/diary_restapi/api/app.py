...
from api.user import UserInfoResource, UserLoginResource, UserRegistrationResource, RefreshAccessTokenResource, \
    RevokeAccessTokenResource
from resources.default import DefaultResource

from flask_jwt_extended import JWTManager
from api.user import black_list
...
def create_app(config_name):
    # import our resource folder to avoid circular dependancy error
    import resources
